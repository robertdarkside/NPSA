    ...
    <div className="relative">
      ...
      <div className="flex min-h-screen flex-col items-center">
        ...
        <div className="w-full bg-[#f5f5f5] flex flex-col gap-4 items-center justify-center pb-6">
          ...
          <div className="underline text-blue-600 font-medium flex gap-3 items-center w-fit text-center">
            <Link
              to="https://www.id.me/about?_ga=2.216094166.1595513186.1708249008-1838405033.1684616461"
              className="w-fit"
            >
              What is ID.me
            </Link>
            ...
            <Link
              to="https://www.id.me/terms?_ga=2.48903142.1595513186.1708249008-1838405033.1684616461"
              className="w-fit"
            >
              Terms of service
            </Link>
            <span className="text-black">|</span>
            <Link
              to="https://www.id.me/privacy?_ga=2.48903142.1595513186.1708249008-1838405033.1684616461"
              className="w-fit"
            >
              Privacy Policy
            </Link>
